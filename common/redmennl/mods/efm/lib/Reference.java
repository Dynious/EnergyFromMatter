...
public class Reference
{
    ...
    public static final String SERVER_PROXY_CLASS = "redmennl.mods.efm.core.proxy.CommonProxy";
    public static final String CLIENT_PROXY_CLASS = "redmennl.mods.efm.core.proxy.ClientProxy";
}