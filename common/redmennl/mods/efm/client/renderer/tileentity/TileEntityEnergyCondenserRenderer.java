        ...
        TileEntitySpecialRenderer
{
            ...
            double z, float tick)
    {
        if (tileEntity instanceof TileEnergyCondenser)
        {
            ...
            {
                direction = ForgeDirection.getOrientation(tileEnergyCondenser
                        .getBlockMetadata());
            }
            FMLClientHandler.instance().getClient().renderEngine
                    .bindTexture(Resources.MODEL_ENERGY_CONDENSER);
            GL11.glPushMatrix();
            ...
            float adjustedLidAngle = tileEnergyCondenser.prevLidAngle
                    + (tileEnergyCondenser.lidAngle - tileEnergyCondenser.prevLidAngle)
                    * tick;
            adjustedLidAngle = 1.0F - adjustedLidAngle;
            adjustedLidAngle = 1.0F - adjustedLidAngle * adjustedLidAngle
                    * adjustedLidAngle;
            modelChest.chestLid.rotateAngleX = -(adjustedLidAngle
                    * (float) Math.PI / 2.0F);
