...
public class RecipesIC2
{
    ...
    private static void init()
    {
        ...
        {
            /*
             * for (Object recipeObject :
             * CraftingManager.getInstance().getRecipeList()) {
             * 
             * if (recipeObject instanceof AdvRecipe || recipeObject instanceof
             * AdvShapelessRecipe) {
             * 
             * IRecipe recipe = (IRecipe) recipeObject; ItemStack recipeOutput =
             * recipe.getRecipeOutput();
             * 
             * if (recipeOutput != null) {
             * 
             * ArrayList<CustomWrappedStack> recipeInputs =
             * getRecipeInputs(recipe); Ic2Recipes.put(new
             * CustomWrappedStack(recipeOutput), recipeInputs); } } }
             */
    ...
    private static CustomWrappedStack getWrappedStack(ItemStack stack)
    {
        ...
        {
            wrappedStack = new CustomWrappedStack(new OreStack(outputOreName,
                    stack.stackSize));
        } else
        {
